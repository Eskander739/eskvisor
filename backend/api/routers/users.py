...
from api.dependencies import get_logger, get_redis_service, get_users_db, get_hash_service, get_jwt_service
...
async def logout(request: Request, logger = Depends(get_logger), redis_service = Depends(get_redis_service)):
    """
    Выход из аккаунта
    """
...
async def login(request: Request,
                response: Response, user_login: UserAuth,
