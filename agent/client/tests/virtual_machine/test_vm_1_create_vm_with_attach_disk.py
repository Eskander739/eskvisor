...
from agent.client.hypervisor.libvirt.models.volume.disk import DiskCreate, DiskAttach, DiskFormat
...
def test_vm_01_create_vm_with_attach_disk(vm_session, network_session):
    ...
    vm_template = VMCreateRequest(
        name=random_name,
        disks=[DiskAttach(name=disk_name, path="/home/eska", format=DiskFormat.QCOW2, vm_name=random_name)],
        vcpus=2,
        memory_mb=512,
        boot_uefi=True,
