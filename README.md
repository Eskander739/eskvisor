...
│   │   │   ├───ha # Директория с HA контроллером для синхронизации и взаимодействия с внешним хранилищем
│   │   │   │   └───controller.py # Файл-менеджер с HA контроллером для синхронизации и взаимодействия с внешним хранилищем
